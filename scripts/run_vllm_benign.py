...
from jbb_repro.vllm_workflows import run_benign_vicuna


def parse_args() -> argparse.Namespace:
    parser = argparse.ArgumentParser(description="Run benign JBB behavior prompts against a local vLLM model.")
...
def main() -> None:
    args = parse_args()
    result = run_benign_vicuna(args.config, limit=args.limit, dry_run=args.dry_run)
