...
from jbb_repro.workflows import score_openai_judge


def parse_args() -> argparse.Namespace:
    parser = argparse.ArgumentParser(description="Score saved JBB responses with an OpenAI API judge.")
    ...
    parser.add_argument("--judge-model", default="gpt-4o-mini", help="OpenAI model to use as the judge.")
